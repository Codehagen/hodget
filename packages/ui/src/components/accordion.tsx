...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Panel
      ...
      className="h-(--accordion-panel-height) overflow-hidden text-xs transition-[height] duration-200 ease-out-quart data-starting-style:h-0 data-ending-style:h-0"
      {...props}
    >
      <div
        className={cn(
