...
/**
 * Equity curve for a single run. Same Recharts contract as the dashboard curve:
 * `isAnimationActive` from useChartAnimation AND a key on the chart root, both
 * required or the series renders invisible.
 */
export function RunEquityChart({ data }: { data: EquityPoint[] }) {
  ...
  return (
    <ChartContainer config={equityConfig} className="aspect-auto h-64 w-full">
      ...
      >
        <defs>
          <linearGradient id="fillRunEquity" x1="0" y1="0" x2="0" y2="1">
